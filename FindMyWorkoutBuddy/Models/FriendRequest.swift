...
struct ApiFriendRequest : Codable {
    
    let result : [ResFriendRequest]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResFriendRequest].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResFriendRequest : Codable {
    ...
    let user_details : RetUserDetails?
    ...
    init(from decoder: Decoder) throws {
        ...
        user_details = try values.decodeIfPresent(RetUserDetails.self, forKey: .user_details)
    }
}

struct RetUserDetails : Codable {
