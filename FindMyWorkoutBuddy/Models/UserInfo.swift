...
struct ApiUserInfo : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResUserInfo.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResUserInfo : Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case friend_count = "friend_count"
    ...
    init(from decoder: Decoder) throws {
        ...
        friend_status = try values.decodeIfPresent(String.self, forKey: .friend_status)
        feed_post_count = try values.decodeIfPresent(Int.self, forKey: .feed_post_count)
        friend_count = try values.decodeIfPresent(Int.self, forKey: .friend_count)
        feed_post = try values.decodeIfPresent([ResFeedPosts].self, forKey: .feed_post)
    }
}

struct ResFeedPosts : Codable {
    let id : String?
    let user_id : String?
