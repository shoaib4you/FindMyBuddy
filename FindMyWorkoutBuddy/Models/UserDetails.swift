...
struct ApiUserDetails : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResUserDetail.self, forKey: .result)
...
struct ResUserDetail : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        feed_post = try values.decodeIfPresent([ResFeedPost].self, forKey: .feed_post)
    }
}

struct ResFeedPost : Codable {
