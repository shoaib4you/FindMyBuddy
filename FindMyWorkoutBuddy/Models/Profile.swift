...
struct ResProfile : Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case profile_exp_date_status = "profile_exp_date_status"
    ...
    init(from decoder: Decoder) throws {
        ...
        profile_exp_date_status = try values.decodeIfPresent(String.self, forKey: .profile_exp_date_status)
        ...
        plan_details = try values.decodeIfPresent(ResPlan.self, forKey: .plan_details)
    }
